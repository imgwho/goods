...
var config = {
    ...
    "img_tpl":'<div class="imgDiv"><img src=""  style="width:100px; height:100px;"/><span onclick="remove_img(this)"></span></div>',//页面上显示的图片标签模板。可以自己添加属性，不要删除已有的
    ...
    'server_url':"http://imgyasuo.lyqianniu.com/server.php",//提交数据远程服务器地址
