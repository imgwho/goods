...
var configFace = {
    ...
    'server_urlFace':"http://www.lvdoya.com/app/imgUploadPHP/upImg_carbonNetuFace.php",//提交数据远程服务器地址
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data.status==1){
				...
				var filename=data.filename.replace("../imgNetuFace/",""); 
				$("#hid_netuFace").val("<img src='http://www.lvdoya.com/app/imgNetuFace/"+filename+"'/>");
				console.log("注意:"+$("#hid_netuFace").val());
            }else{
