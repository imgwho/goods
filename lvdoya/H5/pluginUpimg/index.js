...
var config = {
    ...
    "img_tpl":'<div class="imgDiv" style="margin-left:14px; margin-right:14px;"><img src=""  style="max-width:100%; margin-top:5px; margin-bottom:5px;"/><span onclick="remove_img(this)"></span></div>',//页面上显示的图片标签模板。可以自己添加属性，不要删除已有的
    ...
    'img_height':null,//同上
    'quality': 0.6,//压缩质量，可选0-1.默认0.7
    'server_url':"upload_openAccount.php",//提交数据远程服务器地址
    "post_btn_class":".submit_data",//你页面上表单按钮的class, 可以修改成你自己的
    "progress":'#fb_load',
    "uploadid":"#tp"//上传控件的元素id
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data.status==1){
				...
				//document.getElementById("input_tp").value=document.getElementById("input_tp").value+"<img src='"+data.filename+"'/>";
				document.getElementById("upContent").value=document.getElementById("upContent").value+"<img src='"+data.filename+"'/>";
            }else{
